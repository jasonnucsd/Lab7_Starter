describe('Basic user flow for Website', () => {
  ...
  it('Make sure <product-item> elements are populated', async () => {
    ...
    console.log(`Checking product items/${prodItemsData.length}`);
  ...
  it('Clicking the "Add to Cart" button should change button text', async () => {
    ...
    const innerTextJSON = await innerText.jsonValue();
    console.log(`Button's inner text is ${innerTextJSON}}`);
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (const item of items) {
      ...
      const innerText = await button.getProperty('innerText');
      const innerTextJSON = await innerText.jsonValue();
      if (innerTextJSON != "Remove from Cart") {remembered=false;}
    }
  ...
  it('Checking number of items in cart on screen after reload', async () => {
    ...
    for (const item of items) {
      ...
      const innerText = await button.getProperty('innerText');
      const innerTextJSON = await innerText.jsonValue();
      if (innerTextJSON != "Add to Cart") {remembered=false;}
    }
